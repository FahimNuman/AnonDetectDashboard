...
const AddProjectTitleModal = ({ showModal, setShowModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `https://anon-hctxlnvkx-fahimnumans-projects.vercel.app/api/v1/project-title`,
        newProjectTitle
      );
...
export default AddProjectTitleModal;
