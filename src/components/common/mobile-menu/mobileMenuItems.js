module.exports = [
  {
    label: "Blog",
    subMenu: [
      { path: "/project-add", label: "Add-blog" },
      { path: "/project-list", label: "See-BlogList" },
  ...
  },
  {
    label: "Blog Category",
    subMenu: [
      { path: "/create-category", label: "Add blog Category" },
      { path: "/categories-list", label: "See-BlogList" },
